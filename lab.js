...
let me = { name: "Emmanuel Dada", age: 30 };
...
const dog = { name: "Kalyx", color: "Mocha Brown", age: 2, goodBoy: true };

//let myDogsFurColor = dog.color
//console.log("What color is you dog's fur? " + myDogsFurColor);
//console.log(    );
...
console.log("What's your dog's name?: " + dog.name);
console.log("---------------------------------------------------");

//////////////////////////// PROBLEM 4 ////////////////////////////
/* Print out the color of the dog you created in problem 2 using bracket-notation. */
console.log("What color is you dog's fur?: " + dog["color"]);
console.log("---------------------------------------------------");
...
console.log(
  "NEW Food & Book: " + favoriteThings.food + " and " + favoriteThings.book
);
console.log("---------------------------------------------------");
...
function ingredients(obj) {
  let nutritionStats = { carb: "50g", fat: "20g", protein: "80g" };
  let { carb, fat, protien } = nutritionStats;
  let nutritionFacts = [];
  nutritionFacts.push(carb, fat, protien);
